// $Id: basic_ast_visitor.h,v 1.22 2016/04/14 16:23:49 ist178328 Exp $ -*- c++ -*-
...
public:
  ...
  virtual void do_functioninvocation_node(zu::functioninvocation_node * const node, int lvl) = 0;
  virtual void do_functiondeclaration_node(zu::functiondeclaration_node * const node, int lvl) = 0;
  virtual void do_declaration_node(zu::declaration_node * const node, int lvl) = 0;
  virtual void do_functiondefinition_node(zu::functiondefinition_node * const node, int lvl) = 0; 
  virtual void do_address_node(zu::address_node * const node, int lvl) = 0; 
  virtual void do_alloc_node(zu::alloc_node * const node, int lvl) = 0; 
