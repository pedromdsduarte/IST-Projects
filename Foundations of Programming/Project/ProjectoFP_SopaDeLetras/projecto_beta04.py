...
def resposta_string(res):
    #res_sem_rep = retira_repeticoes(res)
    #res_ordenado = ordena_res(res_sem_rep)
...
#def retira_repeticoes(res):
    #res_sem_rep = resposta([])
    #for r in range(len(res)-1):
        #if res_sem_rep == []:
            #res_sem_rep = acrescenta_elemento(res_sem_rep, res[r][0], res[r][1])
        #else:
            #for r_sr in range(len(res_sem_rep),0,-1):
                #print(res_sem_rep)
                #if res[r][0] not in res_sem_rep[r_sr]:
                    #res_sem_rep = acrescenta_elemento(res_sem_rep, res[r][0], res[r][1])
                    #print(res_sem_rep)
    #return res_sem_rep
    
#def retira_repetidos(res):
    #for i in range(len(res)-1,-1,-1):
        #verifica = res[i][0]
        #for r in range(len(res[:i])-1):
            #if verifica in res[r]:
                #del(res[i])
    #return res
