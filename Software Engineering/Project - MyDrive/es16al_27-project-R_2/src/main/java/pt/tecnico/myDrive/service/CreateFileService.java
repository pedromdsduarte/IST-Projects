...
public class CreateFileService extends MyDriveService {
	...
	InvalidTokenException, InvalidFilenameException, DuplicateFilenameException, DuplicateDirectoryException {
		...
		case "link":
			if(content != null)
				md.createLink(name, owner, parent, content); // TO DO - createLink must verify if content is a path
			else
