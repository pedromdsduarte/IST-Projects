...
public class ListDirectoryTest extends AbstractServiceTest {
	...
	public void successEmptyDir() {
		...
		assertEquals("Empty dir content not right!", expected, res);
	}
	...
	public void successNotEmptyDir() {
		...
		md.createPlainFile("newFile", user1, d, "test file\n");
		...
		assertEquals("Not empty dir content not right!", expected, res);
	}
